...
sys.path.insert(0, os.path.abspath("/home/Shared/pingu/sandbox/birdhouse/hummingbird/."))
...
latex_documents = [
  (master_doc, 'project.tex', u'Hummingbird Documentation',
   u'Birdhouse', 'manual'),
]
...
man_pages = [
    (master_doc, 'project', u'Hummingbird Documentation',
     [author], 1)
]
